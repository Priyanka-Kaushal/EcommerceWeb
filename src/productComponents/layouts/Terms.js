  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" sx={{ marginBottom: "20px" }}>
        The Website Owner, including subsidiaries and affiliates (“shonaz.in” or
        “shonaz” or “we” or “us” or “our”) provides the information contained on
        the website or any of the pages comprising the website (“website”) to
        ...
        website terms and conditions, the privacy policy and any other relevant
        terms and conditions, policies and notices which may be applicable to a
        specific section or module of the website.
      </Typography>

      <Typography variant="body1" sx={{ marginBottom: "20px" }}>
        Welcome to shonaz.in. If you continue to browse and use this website you
        ...
        shonaz.in’s relationship with you in relation to this website.
      </Typography>

      <Typography variant="body1" sx={{ marginBottom: "20px" }}>
        The term ‘shonaz’ ‘shonaz.in’ or ‘us’ or ‘we’ refers to the owner of the
        website whose registered office is in Jaipur, Rajasthan. The term ‘you’
      ...
      <Typography variant="body1" sx={{ marginBottom: "20px" }}>
        ...
        and use only. It is subject to change without notice. Neither we nor any
        ...
        and materials found or offered on this website for any particular
      ...
      <Typography>
        ...
        document without [business name]’s prior written consent. Your use of
